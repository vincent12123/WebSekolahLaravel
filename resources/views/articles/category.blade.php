...
@section('title', $category->name . ' Articles - ' . config('app.name'))

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        <a href="{{ route('articles.index') }}" class="text-indigo-600 hover:text-indigo-700 font-medium inline-flex items-center gap-2 mb-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <aside class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-20">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('articles.index') }}" class="flex items-center justify-between px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 transition">
                            <span>All Articles</span>
                        </a>
                    </li>
                    @foreach($categories as $cat)
                        <li>
                            <a href="{{ route('articles.category', $cat) }}" class="flex items-center justify-between px-3 py-2 rounded-lg {{ $cat->id === $category->id ? 'bg-indigo-50 text-indigo-700 font-medium' : 'text-gray-600 hover:bg-gray-50' }} transition">
                                <span>{{ $cat->name }}</span>
        ...
        <main class="lg:col-span-3">
                            ...
                            <a href="{{ route('articles.show', $article) }}" class="block">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                        ...
                                        <span class="text-indigo-600 font-medium text-sm">Read more →</span>
                                    </div>
                                </div>
                            </a>
                        </article>
            ...
            @else
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                    ...
                    <p class="text-gray-600 text-lg">No articles in this category yet.</p>
                </div>
            @endif
        </main>
    </div>
